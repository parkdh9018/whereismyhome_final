<template>
    ...
    <b-col style="text-align: left">
      <b-form @submit="onSubmit" @reset="onReset">
        ...
        <b-button type="submit" variant="btn btn-outline-success" class="m-1">글수정</b-button>
...
<script>
import {modifyArticle, getArticle } from "@/api/boardApi";
...
export default {
  ...
  methods: {
    onSubmit(event) {
      ...
      if (!err) alert(msg);
      else this.type ===  this.modifyArticle();
    },
    onReset(event) {
      event.preventDefault();
